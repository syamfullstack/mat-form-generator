...
export class GlobalFormSettingsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    this.settingsFormGroup = this.formBuilder.group({
      ...
      componentFileName: [this.globalSettings.componentFileName],
      componentName: [this.globalSettings.componentName],
      ...
      errorStatePath: [this.globalSettings.errorStatePath],
      formType: [this.globalSettings.formType]
    });
  }
